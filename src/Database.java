...
////////////////////////////////////////////////////////////////////////////////////
	  ...
	  try 
	  {
		...
		while (rs.next())
		{
			...
			if (userName.equals(usrname)&& pas.equals(passWord))	
			{
				...
				Doc = new Doctor(fname,lname,userName,passWord,secAns);
				//make new Patient object with the patient informations.
				return Doc;
  ...
  public void setNotification(int flag, Patient P)
  {
	 
	 String update = "UPDATE PATIENTDATA SET NOTIFICATION="+flag+" WHERE firstname='"+P.firstName+"' AND lastname='"+P.lastName+"';";
	 try {
  ...
  public void updateSymptoms(Patient P)
  {
	 int symp[]=new int[7];
	 int symp1[]=new int[7];
	 int symp2[]=new int[7];
	 symp = P.getEnterSymptomLevel();
	 symp1=P.getPreviousSymptomLevel1();
	 symp2 =P.getPreviousSymptomLevel2();
	 try {
		 
	  String update = "UPDATE PATIENTDATA SET SYMPTOM1="+symp[0]+",SYMPTOM2=" +symp[1]+",SYMPTOM3="+symp[2]+",SYMPTOM4="+symp[3]+",SYMPTOM5="+symp[4]+",SYMPTOM6="+symp[5]+",SYMPTOM7="+symp[6]+
			  ",PrevSYMPTOM1_1="+symp1[0]+",PrevSYMPTOM1_2="+symp1[1]+",PrevSYMPTOM1_3="+symp1[2]+",PrevSYMPTOM1_4="+symp1[3]+",PrevSYMPTOM1_5="+symp1[4]+",PrevSYMPTOM1_6="+symp1[5]+",PrevSYMPTOM1_7="+symp1[6]+
			  ",PrevSYMPTOM2_1="+symp2[0]+",PrevSYMPTOM2_2="+symp2[1]+",PrevSYMPTOM2_3="+symp2[2]+",PrevSYMPTOM2_4="+symp2[3]+",PrevSYMPTOM2_5="+symp2[4]+",PrevSYMPTOM2_6="+symp2[5]+",PrevSYMPTOM2_7="+symp2[6]+
