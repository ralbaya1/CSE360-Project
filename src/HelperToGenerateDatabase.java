...
/* This is a helper Class to test and 
 * generate patients in the database. 
 * 
 */

public class HelperToGenerateDatabase {
	...
	public static void main(String[] args) {
		...
		/********************************************************************************************
		 * This section generates 5 Patients in the database 
		 *  
		 *  */
		...
		/************************************************************
		 * This Section Generates 5 doctors in the database patients.db
		 * 
		 */
		//for (int i =0; i <5; i++)
		...
		/***********************************************************************************/
		/* This section gets patinets lists of doctor and print them out*/
